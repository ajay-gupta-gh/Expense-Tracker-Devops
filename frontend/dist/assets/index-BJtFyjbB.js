import{r as u,a as me,u as Q,L as xe,B as ge,R as he,b as z,c as fe}from"./vendor-DyZJ2TT3.js";import{a as ye}from"./utils-DhXgJQ-f.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&o(i)}).observe(document,{childList:!0,subtree:!0});function a(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function o(r){if(r.ep)return;r.ep=!0;const n=a(r);fetch(r.href,n)}})();var ee={exports:{}},F={};/**
 * @license React
 ...
 */var be=u,ve=Symbol.for("react.element"),je=Symbol.for("react.fragment"),Ne=Object.prototype.hasOwnProperty,we=be.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,ke={key:!0,ref:!0,__self:!0,__source:!0};function te(e,s,a){var o,r={},n=null,i=null;a!==void 0&&(n=""+a),s.key!==void 0&&(n=""+s.key),s.ref!==void 0&&(i=s.ref);for(o in s)Ne.call(s,o)&&!ke.hasOwnProperty(o)&&(r[o]=s[o]);if(e&&e.defaultProps)for(o in s=e.defaultProps,s)r[o]===void 0&&(r[o]=s[o]);return{$$typeof:ve,type:e,key:n,ref:i,props:r,_owner:we.current}}F.Fragment=je;F.jsx=te;F.jsxs=te;ee.exports=F;var t=ee.exports,H={},K=me;H.createRoot=K.createRoot,H.hydrateRoot=K.hydrateRoot;let Ce={data:""},Ee=e=>{if(typeof window=="object"){let s=(e?e.querySelector("#_goober"):window._goober)||Object.assign(document.createElement("style"),{innerHTML:" ",id:"_goober"});return s.nonce=window.__nonce__,s.parentNode||(e||document.head).appendChild(s),s.firstChild}return e||Ce},_e=/(?:([\u0080-\uFFFF\w-%@]+) *:? *([^{;]+?);|([^;}{]*?) *{)|(}\s*)/g,Se=/\/\*[^]*?\*\/|  +/g,X=/\n+/g,_=(e,s)=>{let a="",o="",r="";for(let n in e){let i=e[n];n[0]=="@"?n[1]=="i"?a=n+" "+i+";":o+=n[1]=="f"?_(i,n):n+"{"+_(i,n[1]=="k"?"":s)+"}":typeof i=="object"?o+=_(i,s?s.replace(/([^,])+/g,p=>n.replace(/([^,]*:\S+\([^)]*\))|([^,])+/g,d=>/&/.test(d)?d.replace(/&/g,p):p?p+" "+d:d)):n):i!=null&&(n=n[1]=="-"?n:n.replace(/[A-Z]/g,"-$&").toLowerCase(),r+=_.p?_.p(n,i):n+":"+i+";")}return a+(s&&r?s+"{"+r+"}":r)+o},E={},se=e=>{if(typeof e=="object"){let s="";for(let a in e)s+=a+se(e[a]);return s}return e},Oe=(e,s,a,o,r)=>{let n=se(e),i=E[n]||(E[n]=(d=>{let c=0,l=11;for(;c<d.length;)l=101*l+d.charCodeAt(c++)>>>0;return"go"+l})(n));if(!E[i]){let d=n!==e?e:(c=>{let l,m,g=[{}];for(;l=_e.exec(c.replace(Se,""));)l[4]?g.shift():l[3]?(m=l[3].replace(X," ").trim(),g.unshift(g[0][m]=g[0][m]||{})):g[0][l[1]]=l[2].replace(X," ").trim();return g[0]})(e);E[i]=_(r?{["@keyframes "+i]:d}:d,a?"":"."+i)}let p=a&&E.g;return a&&(E.g=E[i]),((d,c,l,m)=>{m?c.data=c.data.replace(m,d):c.data.indexOf(d)===-1&&(c.data=l?d+c.data:c.data+d)})(E[i],s,o,p),i},$e=(e,s,a)=>e.reduce((o,r,n)=>{let i=s[n];if(i&&i.call){let p=i(a),d=p&&p.props&&p.props.className||/^go/.test(p)&&p;i=d?"."+d:p&&typeof p=="object"?p.props?"":_(p,""):p===!1?"":p}return o+r+(i??"")},"");function U(e){let s=this||{},a=e.call?e(s.p):e;return Oe(a.unshift?a.raw?$e(a,[].slice.call(arguments,1),s.p):a.reduce((o,r)=>Object.assign(o,r&&r.call?r(s.p):r),{}):a,Ee(s.target),s.g,s.o,s.k)}let ae,V,W;U.bind({g:1});let w=U.bind({k:1});function Ae(e,s,a,o){_.p=s,ae=e,V=a,W=o}function S(e,s){let a=this||{};return function(){let o=arguments;function r(n,i){let p=Object.assign({},n),d=p.className||r.className;a.p=Object.assign({theme:V&&V()},p),a.o=/go\d/.test(d),p.className=U.apply(a,o)+(d?" "+d:"");let c=e;return e[0]&&(c=p.as||e,delete p.as),W&&c[0]&&W(p),ae(c,p)}return r}}var Le=e=>typeof e=="function",M=(e,s)=>Le(e)?e(s):e,Ie=(()=>{let e=0;return()=>(++e).toString()})(),re=(()=>{let e;return()=>{if(e===void 0&&typeof window<"u"){let s=matchMedia("(prefers-reduced-motion: reduce)");e=!s||s.matches}return e}})(),De=20,G="default",oe=(e,s)=>{let{toastLimit:a}=e.settings;switch(s.type){case 0:return{...e,toasts:[s.toast,...e.toasts].slice(0,a)};case 1:return{...e,toasts:e.toasts.map(i=>i.id===s.toast.id?{...i,...s.toast}:i)};case 2:let{toast:o}=s;return oe(e,{type:e.toasts.find(i=>i.id===o.id)?1:0,toast:o});case 3:let{toastId:r}=s;return{...e,toasts:e.toasts.map(i=>i.id===r||r===void 0?{...i,dismissed:!0,visible:!1}:i)};case 4:return s.toastId===void 0?{...e,toasts:[]}:{...e,toasts:e.toasts.filter(i=>i.id!==s.toastId)};case 5:return{...e,pausedAt:s.time};case 6:let n=s.time-(e.pausedAt||0);return{...e,pausedAt:void 0,toasts:e.toasts.map(i=>({...i,pauseDuration:i.pauseDuration+n}))}}},T=[],ie={toasts:[],pausedAt:void 0,settings:{toastLimit:De}},N={},ne=(e,s=G)=>{N[s]=oe(N[s]||ie,e),T.forEach(([a,o])=>{a===s&&o(N[s])})},le=e=>Object.keys(N).forEach(s=>ne(e,s)),Re=e=>Object.keys(N).find(s=>N[s].toasts.some(a=>a.id===e)),q=(e=G)=>s=>{ne(s,e)},ze={blank:4e3,error:4e3,success:2e3,loading:1/0,custom:4e3},Pe=(e={},s=G)=>{let[a,o]=u.useState(N[s]||ie),r=u.useRef(N[s]);u.useEffect(()=>(r.current!==N[s]&&o(N[s]),T.push([s,o]),()=>{let i=T.findIndex(([p])=>p===s);i>-1&&T.splice(i,1)}),[s]);let n=a.toasts.map(i=>{var p,d,c;return{...e,...e[i.type],...i,removeDelay:i.removeDelay||((p=e[i.type])==null?void 0:p.removeDelay)||(e==null?void 0:e.removeDelay),duration:i.duration||((d=e[i.type])==null?void 0:d.duration)||(e==null?void 0:e.duration)||ze[i.type],style:{...e.style,...(c=e[i.type])==null?void 0:c.style,...i.style}}});return{...a,toasts:n}},Te=(e,s="blank",a)=>({createdAt:Date.now(),visible:!0,dismissed:!1,type:s,ariaProps:{role:"status","aria-live":"polite"},message:e,pauseDuration:0,...a,id:(a==null?void 0:a.id)||Ie()}),D=e=>(s,a)=>{let o=Te(s,e,a);return q(o.toasterId||Re(o.id))({type:2,toast:o}),o.id},y=(e,s)=>D("blank")(e,s);y.error=D("error");y.success=D("success");y.loading=D("loading");y.custom=D("custom");y.dismiss=(e,s)=>{let a={type:3,toastId:e};s?q(s)(a):le(a)};y.dismissAll=e=>y.dismiss(void 0,e);y.remove=(e,s)=>{let a={type:4,toastId:e};s?q(s)(a):le(a)};y.removeAll=e=>y.remove(void 0,e);y.promise=(e,s,a)=>{let o=y.loading(s.loading,{...a,...a==null?void 0:a.loading});return typeof e=="function"&&(e=e()),e.then(r=>{let n=s.success?M(s.success,r):void 0;return n?y.success(n,{id:o,...a,...a==null?void 0:a.success}):y.dismiss(o),r}).catch(r=>{let n=s.error?M(s.error,r):void 0;n?y.error(n,{id:o,...a,...a==null?void 0:a.error}):y.dismiss(o)}),e};var Me=1e3,Fe=(e,s="default")=>{let{toasts:a,pausedAt:o}=Pe(e,s),r=u.useRef(new Map).current,n=u.useCallback((m,g=Me)=>{if(r.has(m))return;let f=setTimeout(()=>{r.delete(m),i({type:4,toastId:m})},g);r.set(m,f)},[]);u.useEffect(()=>{if(o)return;let m=Date.now(),g=a.map(f=>{if(f.duration===1/0)return;let k=(f.duration||0)+f.pauseDuration-(m-f.createdAt);if(k<0){f.visible&&y.dismiss(f.id);return}return setTimeout(()=>y.dismiss(f.id,s),k)});return()=>{g.forEach(f=>f&&clearTimeout(f))}},[a,o,s]);let i=u.useCallback(q(s),[s]),p=u.useCallback(()=>{i({type:5,time:Date.now()})},[i]),d=u.useCallback((m,g)=>{i({type:1,toast:{id:m,height:g}})},[i]),c=u.useCallback(()=>{o&&i({type:6,time:Date.now()})},[o,i]),l=u.useCallback((m,g)=>{let{reverseOrder:f=!1,gutter:k=8,defaultPosition:R}=g||{},A=a.filter(x=>(x.position||R)===(m.position||R)&&x.height),B=A.findIndex(x=>x.id===m.id),L=A.filter((x,C)=>C<B&&x.visible).length;return A.filter(x=>x.visible).slice(...f?[L+1]:[0,L]).reduce((x,C)=>x+(C.height||0)+k,0)},[a]);return u.useEffect(()=>{a.forEach(m=>{if(m.dismissed)n(m.id,m.removeDelay);else{let g=r.get(m.id);g&&(clearTimeout(g),r.delete(m.id))}})},[a,n]),{toasts:a,handlers:{updateHeight:d,startPause:p,endPause:c,calculateOffset:l}}},Ue=w`
from {
...
//# sourceMappingURL=index-BJtFyjbB.js.map
